...
class Agent:
    ...
    def get_state(self, game):
        ...
        # making 4 points around the head of the snake
        head = game.snake[0]
        ...
        state = [
            ...
            game.food.y < game.head.y,  # food is upwards of snake
            game.food.y > game.head.y  # food is downwards of snake
            ]
    ...
    def train():
        ...
        while True:
            ...
            # move and get a new state
            reward, done, score = game.play_step(final_move)
            state_new = agent.get_state(game)
            
            # train the agent's short memory
            agent.train_short_memory(state_old, final_move, reward, state_new, done)
            
            # remember  the states and moves
            agent.remember(state_old, final_move, reward, state_new, done)
            
            if done:
                # train replay memory on the previous moves and games, plot result
                game.reset()
